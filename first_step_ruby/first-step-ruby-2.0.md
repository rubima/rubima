...
現在最新の安定版の Ruby はバージョン 2.1.1 です。  
まだまだ 1.9.3 も多い状況ですが、これから Ruby を学び始めるのであれば、2.1.1 で問題ないと思います。
...
OS X Mavericks(10.9)以降では 2.0.0 系が入っています。これを使うのもいいですが、最新の 2.1.1 を入れるのをお勧めします。
